document.addEventListener('DOMContentLoaded', async function () {
    ...
    try {
        const response = await axios.get('https://placement-app-7bd1.onrender.com/api/company/all',{headers});
        ...
        `;
            ...
            saveButton.addEventListener('click', async (e) => {
                ...
                try {
                    const response = await axios.post(`https://placement-app-7bd1.onrender.com/api/company/${interview._id}`, { result: resultInput },{headers});
                    if (response.data.success) {
                        location.reload();
                    }
